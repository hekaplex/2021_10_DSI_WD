...
'''
taxrate = 0.06
def salestax(costofitem):
    salestax = round(costofitem*taxrate, 2)
    return salestax
def aftertaxtotoal(costofitem):
    aftertaxtotoal = round((costofitem + costofitem*taxrate),2)
    return aftertaxtotoal
def main():
    cost = float(input('Cost of item: '))
    print(salestax(cost))
    print(aftertaxtotoal(cost))
